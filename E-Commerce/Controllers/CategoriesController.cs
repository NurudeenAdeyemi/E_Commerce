...
namespace E_Commerce.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            var eCommerceContext = _context.Categories.Include(c => c.Parent);
        ...
        {
            ViewData["ParentId"] = new SelectList(_context.Categories, "Id", "CategoryName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryName,ParentId")] Category category)
        {
            ...
            ViewData["ParentId"] = new SelectList(_context.Categories, "Id", "CategoryName", category.ParentId);
            return View(category);
        }
